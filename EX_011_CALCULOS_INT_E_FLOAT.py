...
calc_2 = (n1 * 3) + r1
calc_3 = r1 ** 2
print(f'O dobro do primeiro valor {n1} com metade do segundo valor {n2}, resulta no produto {calc_1:.2f}')
print(f'A soma do triplo do primeiro valor {n1} com o valor do terceiro {r1} resulta no produto {calc_2:.2f}')
